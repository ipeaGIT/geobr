...
#'
#' The Immediate Geographic Areas are part of the geographic division of Brazil created by IBGE in 2017,
#' and it was created to replace the "Micro Regions" division. Data at scale 1:250,000, using Geodetic
