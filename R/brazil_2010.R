...
#'
#' \itemize{
#'   \item \code{code_muni}: IBGE code of municipality (7-digit, numeric)
#'   \item \code{name_muni}: Title-case name of municipality (character)
#'   \item \code{code_micro}: IBGE code of micro region (5-digit, numeric)
#'   \item \code{name_micro}: Title-case name of micro region (character)
#'   \item \code{code_meso}: IBGE code of meso region (4-digit, numeric)
#'   \item \code{name_meso}: Title-case name of meso region (character)
#'   \item \code{code_state}: IBGE code of State (2-digit, numeric)
...
#'   \item \code{code_region}: IBGE code of region (1-digit, numeric)
