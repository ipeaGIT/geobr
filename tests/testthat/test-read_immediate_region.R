...
test_that("read_immediate_region", {
  ...
  # wrong code_immediate
  expect_error(read_immediate_region(code_immediate = 99999999,year = NULL))
  expect_error(read_immediate_region(code_immediate = "xxx" ,year = NULL))
