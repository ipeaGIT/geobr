...
test_that("read_meso_region", {
  ...
  # read data
  test_code <- geobr::read_meso_region(code_meso=1401, year=2010)
  test_code2 <- geobr::read_meso_region(code_meso=1401, year=NULL)
...
test_that("read_meso_region", {
  ...
  # Wrong year  expect_error(geobr::read_meso_region(code_meso="xxx", year=NULL))
    expect_error(geobr::read_meso_region(code_meso=11, year=9999999))
    expect_error(geobr::read_meso_region(code_meso=11, year= "xx"))
    expect_error(geobr::read_meso_region(code_meso=1401, year=9999999))
    expect_error(geobr::read_meso_region(code_meso=1401, year= "xx"))

    expect_error(geobr::read_meso_region(code_meso="SC", year=9999999))
    expect_error(geobr::read_meso_region(code_meso="SC", year="xx"))

    expect_error(geobr::read_meso_region(code_meso="all", year=9999999))
    expect_error(geobr::read_meso_region(code_meso="all", year="xx"))
