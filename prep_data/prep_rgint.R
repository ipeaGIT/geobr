...
temp_sf <- dplyr::rename(temp_sf, code_rgint = rgint, name_rgint = nome_rgint) %>%
  dplyr::mutate(year = 2017,
                ...
                name_state =  ifelse(code_state== 11, "Rond?nia",
                              ...
                              ifelse(code_state== 32, "Esp?rito Santo",
                              ifelse(code_state== 33, "Rio de Janeiro",
                              ifelse(code_state== 35, "S?o Paulo",
