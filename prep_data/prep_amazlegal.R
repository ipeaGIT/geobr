...
#> Metadata:
# Titulo: Amzônia legal
# Titulo alternativo: Amazônia legal
...
# Character set: Utf-8
#
# Resumo: Poligonos e Pontos da amzônia legal brasileia.
...
# Root directory
root_dir <- "C:\\Users\\b3858145\\Desktop"
setwd(root_dir)

# Directory to keep raw zipped files
dir.create("./amazlegal")
destdir_raw <- paste0("./amazlegal/",update)
dir.create(destdir_raw)


# Create folders to save clean sf.rds files  -----------------
dir.create("./amazlegal/shapes_in_sf_cleaned", showWarnings = FALSE)
destdir_clean <- paste0("./amazlegal/shapes_in_sf_cleaned/",update)
...
for(i in 1:length(ftp)){
  download.file(url = ftp[i],
                destfile = paste0(destdir_raw,"/","amazlegal.",aux_ft[i]))
}
...
# alterar pasta de destino depois
shape <- system.file("C:\\Users\\b3858145\\Desktop\\amazlegal\\2014\\amazlegal.shp", package = "sf")
...
# erro  em 'dns'
st_read(system.file("C:\\Users\\b3858145\\Desktop\\amazlegal\\2014\\amazlegal.shp", package = "sf"), options = "ENCODING=latin1")

# código modificado até aqui
#------------------------------------------------------------------------------------------------
#------------------------------------------------------------------------------------------------
