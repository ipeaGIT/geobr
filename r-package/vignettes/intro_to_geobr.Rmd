...
df <- data.frame( uf = c("Acre","Alagoas","Amapá",
                   "Amazônas","Bahia","Ceará",
                   ...
                   "Tocantins"),
      ESPVIDA2017 = c(74.25,71.97,74.19,72.14,73.71,
                           74.07,78.37,76.02,74.34,70.85,75.8,
                           74.47,77.49,73.53,75.55,72.29,
                           74.27,71.23,76.48,75.96,75.95,71.53,
                           71.84,76.97,76.26,72.92,73.65))
...
# join the databases
  states <- left_join(states, df, by = c("name_state" = "uf"))
```
