...
if(update == 2019){
  sf::st_write(temp_sf, dsn = paste0(destdir_clean, "/intermediate_regions_2019.gpkg") )
  sf::st_write(temp_sf_simplified, dsn = paste0(destdir_clean, "/intermediate_regions_2019_simplified.gpkg") )
}
